...
public class SATAlgorithmLTest extends SATTestBase {
    ...
    private final Function<SATProblem, AbstractSATSolver> LX = p -> {
        SATAlgorithmL a = new SATAlgorithmLX(p);
    ...
    @Test public void w3_3_L3NoX() { assertThat(waerden(3, 3, L3NoX), is(9)); }
    @Test public void w3_4_L3NoX() { assertThat(waerden(3, 4, L3NoX), is(18)); }
    @Test public void w3_4_L3NoY() { assertThat(waerden(3, 4, L3NoY), is(18)); }

    @Test public void w3_4_L3() { assertThat(waerden(3, 4, L3), is(18)); }
    ...
    /* switch to L */
    @Test public void w4_3_LNoX() { assertThat(waerden(4, 3, LNoX), is(18)); }
    @Test public void w4_4_LNoX() { assertThat(waerden(4, 4, LNoX), is(35)); }
    @Test public void w3_6_LNoX() { assertThat(waerden(3, 6, LNoX), is(32)); }
    @Test public void w3_7_LNoX() { assertThat(waerden(3, 7, LNoX), is(46)); }
    @Test public void w3_8_LNoX() { assertThat(waerden(3, 8, LNoX), is(58)); }
    @Test public void w4_5_LNoX() { assertThat(waerden(4, 5, LNoX), is(55)); }
    @Test public void w5_4_LNoX() { assertThat(waerden(5, 4, LNoX), is(55)); }
    @Test public void w6_3_LNoX() { assertThat(waerden(6, 3, LNoX), is(32)); }
    @Test public void w7_3_LNoX() { assertThat(waerden(7, 3, LNoX), is(46)); }
    @Test public void w8_3_LNoX() { assertThat(waerden(8, 3, LNoX), is(58)); }

    @Test public void w3_3_LXNoX() { assertThat(waerden(3, 3, LXnoX), is(9)); }

    @Test public void w3_3() { assertThat(waerden(3, 3, L), is(9)); }
    @Test public void w4_3() { assertThat(waerden(4, 3, L), is(18)); }
    @Test public void w4_3_X() { assertThat(waerden(4, 3, LX), is(18)); }
